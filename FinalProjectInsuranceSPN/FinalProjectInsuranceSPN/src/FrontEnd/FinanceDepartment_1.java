 ...
 * @author Neha
 */
public class FinanceDepartment_1 extends javax.swing.JFrame {
     Connection conn;
...
//    ArrayList<Finance> manage = new ArrayList<>();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String customer_id = jTextField1.getText();
        ...
        try {
            ...
            Logger.getLogger(FinanceDepartment_1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinanceDepartment_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinanceDepartment_1().setVisible(true);
            }
        });
    }
