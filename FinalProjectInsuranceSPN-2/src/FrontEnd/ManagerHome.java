...
import Model.ClaimInfo;
import Model.CustomerData;
import Model.HealthPricing;
import Model.JdbcConnection;
import Model.ManagePolicies;
import Model.SalesCommison;
...
//    ArrayList<ClaimInfo> claim = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(230, 195, 108));
        jPanel3.setForeground(new java.awt.Color(230, 195, 108));
        ...
        jButton8.setBackground(new java.awt.Color(0, 31, 63));
        jButton8.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        jButton8.setForeground(new java.awt.Color(218, 165, 32));
        ...
        jPanel2.setForeground(new java.awt.Color(230, 195, 108));
        ...
        jButton9.setBackground(new java.awt.Color(0, 31, 63));
        jButton9.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton9.setForeground(new java.awt.Color(218, 165, 32));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 8767, Short.MAX_VALUE)
        ...
        try {
            ...
            while(rs.next())
            {
               email = rs.getString("email");
                ...
                try {
                    EmailFunction.managerapproved.sendMail(email);
                } catch (Exception ex) {
                    Logger.getLogger(ManagerHome.class.getName()).log(Level.SEVERE, null, ex);
                } 
